...
class Users
{
     ...
     *         required=true,
     *         @OA\JsonContent(
     *             @OA\Property(property="name", type="string", example="Updated Name", description="User's updated name"),
     *             @OA\Property(property="email", type="string", format="email", example="updated@example.com", description="User's updated email")
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
